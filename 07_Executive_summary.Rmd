...
ggsave("figs\\IUCN_world_sharks_alluvial3.png", width = 8, height = 12, units = "cm")
...
ggplot(heatmap_df, aes(Region, Species)) +
  ...
  theme(axis.title.x = element_blank(),
        ...
        legend.position = "bottom") + facet_grid(~Level, switch = "x", scales = "free_x", space = "free_x")

ggsave("figs\\heatmap_all.png", width = 8, height  = 12)
```
