...
## HTML final table
```{r}
Elasmo_with_OSPAR <- read_xlsx("data\\Elasmo_final_table_with_OSPAR.xlsx") %>% drop_na("Dernier statut") %>% select(-1)
...
iucn_cols <- function(x){
  ...
  else if(x == "declining") {"mediumvioletred"}
  else if(x == "stable"){"sandybrown"}
  else if(x == "recovering"){"aquamarine"}
  else if(x == "unknown"){"lightgrey"}
  else if(x == "Good"){"lightgreen"}
  else if(x == "Poor"){"orange"}
  else if(x == "Unknown"){"lightgrey"}
