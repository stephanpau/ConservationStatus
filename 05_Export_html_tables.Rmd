...
```{r data}
#IUCN_status
Elasmobranchs_IUCN_historical_status <- read.csv("data\\Elasmobranchs_IUCN_historical_status.csv", encoding = "UTF-8",check.names = F) %>% filter(Region != "France (continental)") %>% select(-"Before_last_evaluation", -"Before_last_status")
